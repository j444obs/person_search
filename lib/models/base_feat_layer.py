...
class BaseFeatLayer(nn.Module):
    ...
    def __init__(self):
        ...
        self.BN_1 = nn.BatchNorm2d(64, track_running_stats=False)
        ...
        self.BN_8 = nn.BatchNorm2d(64, track_running_stats=False)
